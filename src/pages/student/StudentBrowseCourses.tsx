...
export default function StudentBrowseCourses() {
  ...
  const handleCouponModalClose = (val: boolean) => {
    if (!verifying) {
      ...
      if (!val && verified) {
        // Navigate to my courses after closing success
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Explore our cybersecurity programs and enroll with your access coupon
            </p>
          </div>
          <Button
            size="lg"
          ...
          <TabsContent value="diploma" className="mt-6 space-y-8">
            ...
            <div className="space-y-4">
              {diplomaPhases.map((phase, idx) => (
                <Accordion key={phase.number} type="single" collapsible>
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="font-display font-semibold text-lg text-foreground">Completion Includes</h4>
                  </div>
            ...
            <div className="p-6 rounded-2xl bg-primary/5 border border-primary/20 text-center">
              ...
              <p className="text-muted-foreground mb-4 text-sm">
                Use your access coupon to enroll in the Professional Diploma program.
              </p>
              <Button size="lg" onClick={() => setCouponModalOpen(true)}>
                <KeyRound className="w-4 h-4 mr-2" />
                Enter Access Coupon
              </Button>
            </div>
          ...
          <AnimatePresence mode="wait">
            {verified ? (
              <motion.div
                ...
                className="flex flex-col items-center py-12 px-8 gap-5"
              >
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">
                    All course features are now unlocked!
                  </p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0 }}
